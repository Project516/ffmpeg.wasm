...
const FFMPEG_VERSION = "0.13.0";
const UTIL_VERSION = "0.13.0";
const CORE_VERSION = "0.13.0";
const CORE_MT_VERSION = "0.13.0";
...
const FFMPEG_TGZ_URL = `${NPM_URL}/@project516/ffmpeg/-/${FFMPEG_TGZ}`;
const UTIL_TGZ_URL = `${NPM_URL}/@project516/util/-/${UTIL_TGZ}`;
const CORE_TGZ_URL = `${NPM_URL}/@project516/core/-/${CORE_TGZ}`;
const CORE_MT_TGZ_URL = `${NPM_URL}/@project516/core-mt/-/${CORE_MT_TGZ}`;
