...
~~https://cdn.jsdelivr.net/npm/@project516/core@0.12.10/dist/umd~~ => https://cdn.jsdelivr.net/npm/@project516/core@0.12.10/dist/esm
:::
...
function() {
    ...
    const load = async () => {
        const baseURL = 'https://cdn.jsdelivr.net/npm/@project516/core-mt@0.12.10/dist/umd'
        const ffmpeg = ffmpegRef.current;
        ffmpeg.on('log', ({ message }) => {
            messageRef.current.innerHTML = message;
            console.log(message);
