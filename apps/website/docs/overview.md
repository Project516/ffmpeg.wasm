      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        <TableBody>
          {[
            ...
            {name: "FFmpeg", version: "n9.0.2 (multithread core), n5.1.10 (single-thread core)", note: "FFmpeg is a powerful multimedia framework that can decode, encode, transcode, and stream audio and video files. The single-thread core stays on 5.1.x because its libraries build with --disable-pthreads; the multithread core has real pthreads and builds current FFmpeg. See \"FFmpeg upgrade plan\" in AGENTS.md."},
